!(function(e) {
            ...
            success: function(e) {
              "Feature" === e.type
                ...
                : ((D = e.features.length),
                  ...
                  (T =
                    s === D
                      ? e.features.slice(0, e.features.length - 1)
                      : e.features)),
                o(t),
                (C = t ? 1 : 0);
            },
    ...
    function o(t) {
      ...
      e("#resultsDiv").remove(),
        o.append(
          "<div id='resultsDiv' class='result'><ul id='resultList' class='list'></ul><div>"
        ),
        (e("#resultsDiv")[0].style.position = e("#searchBox")[0].style.position),
        (e("#resultsDiv")[0].style.left =
          parseInt(e("#searchBox")[0].style.left) - 10 + "px"),
        (e("#resultsDiv")[0].style.bottom = e("#searchBox")[0].style.bottom),
        (e("#resultsDiv")[0].style.right = e("#searchBox")[0].style.right),
        (e("#resultsDiv")[0].style.top =
          parseInt(e("#searchBox")[0].style.top) + 25 + "px"),
      ...
      for (var c = 0; r > c; c++) {
        ...
        (u +=
          ...
          c +
          "' class='content'><img src='./image/" +
          k[c].properties.image +
          "' class='iconStyle' align='middle'>"),
          (u +=
            "<font size='2' color='#333' class='title'>" +
            k[c].properties.title +
            "</font><font size='1' color='#8c8c8c'> " +
            k[c].properties.description +
            "<font></span></li>"),
      ...
      if (t) {
        var p = "prev.png",
          ...
          v = "",
          m = "";
        0 === A && ((p = "prev_dis.png"), (v = "disabled")),
          l || ((d = "next_dis.png"), (m = "disabled"));
        var g =
          "<div align='right' class='pagingDiv'>" +
          (A + 1) +
          " - " +
          (A + r) +
          " " +
          b.foundRecordsMessage +
          " ";
        (g +=
          "<input id='pagingPrev' type='image' src='../dist/image/" +
          p +
          "' width='16' height='16' class='pagingArrow' " +
          v +
          ">"),
          (g +=
            "<input id='pagingNext' type='image' src='../dist/image/" +
            d +
            "' width='16' height='16' class='pagingArrow' " +
            m +
            "></div>"),
    ...
    function n(t) {
      var o = parseInt(t.id.substr(11));
      o !== E &&
        (-1 !== E && e("#listElement" + E).removeClass("active"),
        e("#listElement" + o).removeClass("mouseover"),
        e("#listElement" + o).addClass("active"),
        (E = o),
        p(),
        0 === C ? c(E) : r(E));
    }
    function a() {
      void 0 !== B && (m.removeLayer(B), (B = void 0)),
        (B = L.geoJson(T, {
          style: function(e) {
            return { color: "#D0473B" };
          },
        ...
        m.addLayer(B),
        m.fitBounds(B.getBounds());
    }
    function r(e) {
      "Point" === k[e].geometry.type && -1 !== b.pointGeometryZoomLevel
        ? m.setView(
            [k[e].geometry.coordinates[1], k[e].geometry.coordinates[0]],
            b.pointGeometryZoomLevel
          )
        : m.fitBounds(l(k[e].geometry)),
        u(e);
    }
    function l(e) {
    ...
    function c(e) {
      if ((void 0 !== B && (m.removeLayer(B), (B = void 0)), -1 !== e)) {
    ...
    function u(e) {
      if ((void 0 !== x && (m.removeLayer(x), (x = void 0)), -1 !== e)) {
    ...
    function p() {
      -1 === E
        ? (e("#searchBox")[0].value = w)
        : (e("#searchBox")[0].value = k[E].properties.title);
    }
    function d() {
      D > 0 &&
        (-1 !== E && e("#listElement" + E).toggleClass("active"),
        D - 1 > E
          ? (e("#listElement" + (E + 1)).toggleClass("active"), E++)
          : (E = -1),
        p(),
        -1 !== E && (0 === C ? c(E) : r(E)));
    }
    function v() {
      D > 0 &&
        (-1 !== E && e("#listElement" + E).toggleClass("active"),
        -1 === E
          ? (e("#listElement" + (D - 1)).toggleClass("active"), (E = D - 1))
          : 0 === E
          ? E--
          : (e("#listElement" + (E - 1)).toggleClass("active"), E--),
        p(),
    ...
    function m() {
      (e("#searchBox")[0].value = ""),
        ...
        e("#resultsDiv").remove(),
        void 0 !== B && (m.removeLayer(B), (B = void 0)),
        void 0 !== x && (m.removeLayer(x), (x = void 0));
    }
    function g() {
      t(b.pagingActive);
    }
    function f() {
      ...
      e("#resultsDiv").remove(),
        t.append(
          "<div id='resultsDiv' class='result'><i>" +
            w +
            " " +
            b.notFoundMessage +
            " <p><small>" +
    ...
    (e.fn.GeoJsonAutocomplete = function(o) {
      ...
      e(this).each(function() {
        ...
        o.addClass("searchContainer"),
          o.append(
            '<input id="searchBox" class="searchBox" placeholder="' +
              b.placeholderMessage +
              '"/>'
          ),
          o.append(
            '<input id="searchButton" class="searchButton" type="submit" value="" title="' +
              b.searchButtonTitle +
              '"/>'
          ),
          o.append('<span class="divider"></span>'),
          o.append(
            '<input id="clearButton" class="clearButton" type="submit"  value="" title="' +
              b.clearButtonTitle +
              '">'
          ),
          (e("#searchBox")[0].value = ""),
          ...
          e("#searchBox").focus(function() {
            void 0 !== e("#resultsDiv")[0] &&
              (e("#resultsDiv")[0].style.visibility = "visible");
          }),
